        ...
        <div class="d-flex gap-2">
            @if($penduduk->status !== 'diterima')
                <form action="{{ route('penduduk.status', $penduduk) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Tandai sebagai Diterima?')">
            ...
            @if($penduduk->status !== 'ditolak')
                <form action="{{ route('penduduk.status', $penduduk) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Tandai sebagai Ditolak?')">
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body text-center p-3">
                @if($penduduk->foto_rumah)
                    <img src="{{ asset('storage/' . $penduduk->foto_rumah) }}"
                         class="img-fluid rounded" alt="Foto Rumah" style="max-height: 220px; object-fit: cover;">
        ...
        @if($penduduk->hasilSaw)
            <div class="card border-0 shadow-sm bg-{{ $penduduk->hasilSaw->rekomendasi_color }} bg-opacity-10 border-{{ $penduduk->hasilSaw->rekomendasi_color }}">
